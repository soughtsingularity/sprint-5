...
function CourseFormPage() {
  ...
  const handleAddChapter = () => {
    setContent([...content, { title: "", description: "", videos: [{ title: "", description: "", url: "" }] }]);
  };
        ...
        {content.map((chapter, i) => (
          <div key={i} className="border border-gray-300 rounded-lg p-5 space-y-4 bg-white shadow-sm">
            ...
            <div>
              ...
              />
              {renderError(`content.${i}.description`)}
            </div>
            ...
            {chapter.videos.map((video, j) => (
              <div key={j} className="space-y-2 bg-gray-50 p-4 rounded border border-gray-200">
                ...
                />
                {renderError(`content.${i}.videos.${j}.title`)}
                ...
                />
                {renderError(`content.${i}.videos.${j}.description`)}
                ...
                />
                {renderError(`content.${i}.videos.${j}.url`)}
